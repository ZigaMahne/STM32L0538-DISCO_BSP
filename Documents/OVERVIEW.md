...
The **STMicroelectronics STM32L0538-DISCO Board Support Pack (BSP)**:
...
- Requires the [Device Family Pack (DFP) for the STM32L0 series](https://www.keil.arm.com/packs/stm32l0xx_dfp-keil).
...
- [Examples/Blinky](https://github.com/Open-CMSIS-Pack/STM32L0538-DISCO_BSP/tree/main/Examples/Blinky) shows the basic usage of this board.
